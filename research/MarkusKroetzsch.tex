\chapterwithauthor[Out of the Lab, into the Wild]{Markus Kr\"otzsch}{Out of the Lab, into the 

Wild: Growing Open Source Communities around Academic Projects}

\chapterwithauthor[走出实验室，接近大自然]{Markus Kr\"otzsch}{走出实验室，接近大自然：围绕学术项目发展开源社区}
...
\authorbio{Markus Kr\"otzsch 是牛津大学计算机科学部门的博士后研究者。他从KIT（卡尔斯鲁厄理工学院）的AIFB（应用信息学和形式化描述研究所）获得博士学位。他的研究兴趣信息的智能自动处理,而范围从基础的形象表现到Web开发应用领域。他是成功的Web应用程序平台，Semantic MediaWiki的首席开发人员，也是万维网规格的首席编辑，还是社交门户semanticweb.org的主要维修人员，还是教科书，万维网基础，的合著者}
