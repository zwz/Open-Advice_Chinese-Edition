...
\chapterwithauthor{Rich Bowen}{好习惯很重要}
...
\authorbio{Rich Bowen已经为开源资源软件工作了15年。他的大部分的时间都花在Apache HTTP服务器上,
但有时也在Perl、PHP和各种各样的web应用程序上。他是Apache Cookbook, 
The Definitive Guide to Apache mod\_rewrite和其它书的作者,频繁出现在各种技术会议上。
}
