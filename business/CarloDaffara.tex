...
\dots\ fails to contribute to the creation of value in development, as opposed to the commercial software market 
在价值发展的创造性方面没有贡献，与商业软件市场截然相反……
\dots\ does not generate profit, income, jobs or taxes \dots\ The open-source licenses on the software aim to suppress
没有创造利益，收入，工作或税收……开源软件的授权目的在于抑制
any ownership claims to the software and prevent prices from being established for it. 
任何对软件所有权的要求，防止对软件价格的建立。
In the end, the developed software cannot be used to generate profit.'' [Koot 03] or [Eng 10] claims that 
最后，软件的发展不能被用于创造利益。
``economists showed that real world open source collaborations rely on many different incentives such as education,
"经济学家表示真实世界的开源协作依赖许多不同的激励，例如教育，
signaling, and reputation.'' (without any mention of economic incentives). 
信号传递和名声。"(没有提及任何经济激励）
This purely ``social'' view of FLOSS is biased and wrong, 
这种单纯的关于开源软件“社会性的”观念是有偏见的和错误的，
and we will demonstrate that there are economical reasons behind the success of Free/Open Source businesses that go beyond the purely pro-bono collaborations.
而且我们将会证明在那些超越单纯的无偿协作的开源企业成功的背后是有经济原因的

\section*{FLOSS and Economic Realities}
开源软件和经济现实
In most areas, the use of FLOSS brings a substantial economic advantage,
在大多数领域，开源软件的使用带来了一个实质的经济优势
thanks to the shared development and maintenance costs, already described by researchers like Gosh, 
由于发展和维修费用的共享，已经被一些研究者描述成像天啊一类的话，
that estimated an average R\&D cost reduction of 36\%.
因为估计平均费用将会减少36%
The large share of ``internal'' FLOSS deployments explains why some of the economic benefits 
are not perceived directly in the business service market.
开源软件发展中“内部的”巨大的份额解释了为什么一些经济利益不能在商业服务市场里被直接感知到。

The FLOSSIMPACT study found in 2006 that companies contributing code to FLOSS projects have in total at least 570 thousand employees and an annual
