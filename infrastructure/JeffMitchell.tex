...
\chapterwithauthor{Jeff Mitchell}{对未知的爱}
...
\authorbio{Jeff Mitchell在工作时间涉足各种计算机
和网络技术,在业余时间涉足各种开源软件项目
和享受两者兼有的部分。在1999-2005的职业能力担任系统管理员后,他通过各种工作和开源项目提升技术。
目前，他将多数时间用于作为KDE的系统管理员和Tomahawk Player的代码开发员
Tomahawk的球员。他目前住在美国，波士顿。}
...
\begin{quote}
\textbf {Me} {所以你说你没有在Cisco操作系统工作的经验，但通常关于网络呢？\newline
\ textbf {John }:嗯,我是一名系统管理员。\newline
\ textbf {Me}:没错,但是,网络概念怎么样?像BGP,OSPF,VLANs,桥这样的网络协议呢\dots\newline
\ textbf {John,愤怒的} {我是个 \emph{程序员}。
\end{quote}
这时，我们才明白他John在说什么。因为John是个系统管理员，
他没有告诉我们他知道我们问他的各种问题。他告诉我们因为他是系统管理员，
他的确 \emph{不}知道哪些事。John是个\emph{系统}管理员；
